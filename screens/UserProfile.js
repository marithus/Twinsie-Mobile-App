...
const UserProfileScreen = ({navigation}) => {
  ...
  const pickImage = async () => {
    ...
    {
      alert("Sorry image storage access has not been granted by the user. This can be changed in the app settings menu of your user");
      return;
    }
    //open the storage if permission is granted
  ...
  //called when update image button is pressed. uploads and stores the new image file 
          ...
          <View>
            ...
            <TouchableOpacity onPress={pickImage} activeOpacity={0.5} >
              <View style={styles.imageContainer}>
                  <Image style={styles.image} source={{uri: value.file || 'https://www.pngall.com/wp-content/uploads/12/Avatar-PNG-Images-HD.png'}}/>
              </View>
            </TouchableOpacity>
          </View>
